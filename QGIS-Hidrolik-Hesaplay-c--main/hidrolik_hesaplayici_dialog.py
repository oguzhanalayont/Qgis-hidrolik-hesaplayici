...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'hidrolik_hesaplayici_dialog_base.ui'))


class HidrolikHesaplayiciDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(HidrolikHesaplayiciDialog, self).__init__(parent)
